    ...
    public TelemetryController(ILogger<TelemetryController> logger, RuckRDbContext db)
        ...
        private static void AddMapDiagnosticsEvent(Activity activity, string message)
        {
            ...
            try
            {
                ...
                AddBooleanTag(tags, "map.health.healthy", root, "health", "healthy");
                AddBooleanTag(tags, "map.health.ready", root, "health", "ready");
                AddBooleanTag(tags, "map.health.basemap_loaded", root, "health", "basemapLoaded");
                AddBooleanTag(tags, "map.health.view_sized", root, "health", "viewSized");
                AddBooleanTag(tags, "map.health.surface_visible", root, "health", "surfaceVisible");
                AddBooleanTag(tags, "map.health.canvas_visible", root, "health", "canvasVisible");
                AddBooleanTag(tags, "map.health.webgl_context", root, "health", "webGlContext");
                AddBooleanTag(tags, "map.health.has_fatal_error", root, "health", "hasFatalError");
                AddBooleanTag(tags, "map.visual.canvas_present", root, "visual", "canvas", "present");
                AddBooleanTag(tags, "map.visual.surface_visible", root, "visual", "surface", "surfaceVisible");
                AddBooleanTag(tags, "map.visual.canvas_visible", root, "visual", "surface", "canvasVisible");
                AddBooleanTag(tags, "map.visual.surface_matches_view", root, "visual", "surface", "surfaceMatchesView");
                AddBooleanTag(tags, "map.visual.canvas_matches_view", root, "visual", "surface", "canvasMatchesView");
