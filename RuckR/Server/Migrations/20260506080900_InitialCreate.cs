...
namespace RuckR.Server.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpawnLocation = table.Column<Point>(type: "geography", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengerPlayerId = table.Column<int>(type: "int", nullable: false),
                    OpponentPlayerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Battles_AspNetUsers_ChallengerId",
                        column: x => x.ChallengerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Battles_AspNetUsers_OpponentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapturedAtPitchId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Collections_UserId_PlayerId",
                table: "Collections",
                columns: new[] { "UserId", "PlayerId" },
                unique: true);

            // Spatial indexes for geography columns — not supported by EF Core
            // fluent API, so added via raw SQL.
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"DROP INDEX IF EXISTS [IX_Pitches_Location] ON [Pitches];");
