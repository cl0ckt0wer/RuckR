...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RuckR.Shared.Models.BattleModel", b =>
                {
                    ...
                    b.Property<string>("ChallengerMove")
                        .HasMaxLength(20)
                    ...
                    b.Property<DateTime?>("ChallengerSubmittedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("OpponentMove")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<DateTime?>("OpponentSubmittedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ChallengerId", "Status", "CreatedAt");
            ...
            modelBuilder.Entity("RuckR.Shared.Models.PlayerEncounterModel", b =>
                {
                    ...
                    b.Property<int>("RecruitmentBaseDurationSeconds")
                        .HasColumnType("int");

                    b.Property<DateTime?>("RecruitmentCompletesAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<string>("RecruitmentItemKind")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<int>("RecruitmentLocalPlayerCount")
                        .HasColumnType("int");

                    b.Property<int>("RecruitmentRequiredDurationSeconds")
                        .HasColumnType("int");

                    b.Property<DateTime?>("RecruitmentStartedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("AreaKey", "ExpiresAtUtc");

                    b.HasIndex("AreaKey", "PlayerId");
            ...
            modelBuilder.Entity("RuckR.Shared.Models.RecruitmentParticipantModel", b =>
                {
                    ...
                    b.Property<DateTime?>("CollectionAwardedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("EncounterId", "UserId");

                    b.HasIndex("CollectionAwardedAtUtc");
            ...
            modelBuilder.Entity("RuckR.Shared.Models.RecruitmentParticipantModel", b =>
                {
                    b.HasOne("RuckR.Shared.Models.PlayerEncounterModel", "Encounter")
